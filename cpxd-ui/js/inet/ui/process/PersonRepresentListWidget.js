// #PACKAGE: personrepresent-list
// #MODULE: PersonRepresentListWidget
/**
...
$(function() {
  ...
  iNet.ui.ita.PersonRepresentListWidget = function (config) {
    ...
    iNet.ui.ita.PersonRepresentListWidget.superclass.constructor.call(this);
    ...
    var dataSource = new iNet.ui.grid.DataSource({
      columns : [{
        ...
        property : 'nameRepresent',
        label : resource.common.nameRepresent,
        sortable : true,
        type : 'text',
        validate : function(v) {
          if (iNet.isEmpty(v))
        ...
        {
          property : 'birthday',
          label : resource.common.birthday,
          sortable : true,
          type : 'text',
          validate : function(v) {
            if (iNet.isEmpty(v))
        ...
        {
          property : 'religion',
          label : resource.common.religion,
          sortable : true,
          type : 'text',
          validate : function(v) {
            if (iNet.isEmpty(v))
    ...
    /* $('#province-btn-add').on('click', function(){
     ...
     $('#personrepresent-btn-add-dialog').on('click', function(){
